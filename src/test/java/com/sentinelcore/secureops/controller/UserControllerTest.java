...
public class UserControllerTest {
    ...
    public void testUserRegistrationDirectly() {
        ...
        com.sentinelcore.secureops.dto.UserRegistrationRequest request = new com.sentinelcore.secureops.dto.UserRegistrationRequest(
            uniqueUsername,
            "password123",
        ...
        assertTrue(createdUser.roles().contains("ROLE_VIEWER"));
    }
}
